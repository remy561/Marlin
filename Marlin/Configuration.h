...
#define STRING_CONFIG_H_AUTHOR "(Remy Quist, Ender-3 Pro config)" // Who made the changes.
...
#define EXTRUDE_MAXLENGTH (X_MAX_POS + Y_MAX_POS)
...
#define Y_BED_SIZE 230 //E3Dv6 nozzle takes 1cm on y-axis, bed ofset by using glass bed
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FIL_RUNOUT_PIN       P1_24      // Z_MAX
  ...
  #define FILAMENT_RUNOUT_SCRIPT "M600 B10 X0 Y0 Z5 U0 L20" // Beep 10x, move to X0 Y0 Z+5, don't retract, load 2cm of new filament
...
#define HOMING_FEEDRATE_MM_M { (75*60), (75*60), (12*60) }
